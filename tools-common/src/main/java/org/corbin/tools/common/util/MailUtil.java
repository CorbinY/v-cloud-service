...
public class MailUtil {
     ...
     * @param content 发送内容
     */
    public static void sendMail(String toMail, String content, String topic) throws MessagingException, UnsupportedEncodingException {
        //创建连接对象 连接到邮件服务器
    ...
    public static void sendVerificationCode(String mail, String verificationCode,String topic) throws UnsupportedEncodingException, MessagingException {
        ...
        MailUtil.sendMail(mail, html, topic);
    }
