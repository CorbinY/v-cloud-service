...
public class SnowFlakeIdHelper {
  ...
  private static class SnowFlakeInstance {
    private static final SnowFlake SNOW_FLAKE = new SnowFlake(3, 3);
  }

  /** 产生下一个ID */
  public static Long nextId2Long() {
    return SnowFlakeInstance.SNOW_FLAKE.nextId();
  }

  public static String nextId2String() {
    return String.valueOf(SnowFlakeInstance.SNOW_FLAKE.nextId());
  }
